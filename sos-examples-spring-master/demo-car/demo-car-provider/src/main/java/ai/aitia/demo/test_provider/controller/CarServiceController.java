...
import ai.aitia.demo.test_provider.database.InMemoryCarDB;
...
public class CarServiceController {
    ...
    @ResponseBody
    public TestResponseDTO getCarById(
        @PathVariable(
    ...
    @ResponseBody
    public TestResponseDTO updateCar(
        @PathVariable(
